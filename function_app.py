...
def _handle_availability(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        # Beide availability-SP's ondersteunen MonthView zelf, dus er is hier geen onderscheid meer
        # tussen online en buitendienst: één aanroep, de SP levert de hele maand (2026-09-10, zie
        # docs/DECISIONS.md - dit verving een dag-voor-dag-loop in Python).
